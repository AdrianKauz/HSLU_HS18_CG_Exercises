...
export function PolygonCube(gl) {
    ...
    let colors = [
        rgbToV4(104, 139, 158), // Front Side
        rgbToV4(104, 139, 158), // Back Side
        rgbToV4(133, 188, 194), // Top Side
        rgbToV4(133, 188, 194), // Bottom Side
        rgbToV4(221, 121, 138), // Right Side
        rgbToV4(221, 121, 138)  // Left Side
    ];
