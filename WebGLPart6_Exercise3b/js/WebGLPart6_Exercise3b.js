...
function startup() {
    ...
    // CameraMatrix
    cameraViewMatrix.setPosition(Math.PI/3, Math.PI/3, Math.PI/4);
    cameraViewMatrix.setUpDirection(0.0, 0.0, 1.0);
    cameraViewMatrix.setLookAtPosition(0.0, 0.0, 0.0);
    cameraViewMatrix.setDistance(2.5);
...
function setUpAttributesAndUniforms(){
    ...
    ctx.uniforms.uViewPositionId = gl.getUniformLocation(ctx.shaderProgram, 'uViewPositionId');
}
...
function drawScene() {
    ...
    gl.uniformMatrix3fv(ctx.uniforms.uViewPositionId, false, cameraViewMatrix.getCameraPosition());
